...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResourses)("http://localhost:3000/menu").then(function (data) {
...
function slider(_ref) {
  ...
  function changeNumOfSlides(slideIndex, slides, current) {
    if (slides.length < 10) {
  ...
  slider.style.position = 'relative'; // slider navigation 
  ...
  function changeCurrentNavigaton(dots, slideIndex) {
  ...
  next.addEventListener('click', function () {
    ...
    changeNumOfSlides(slideIndex, slides, current);
    changeCurrentNavigaton(dots, slideIndex); // if (slides.length <10) {
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      slidesField.style.transform = "translateX(-".concat(offset, "px)");
      changeNumOfSlides(slideIndex, slides, current); // if (slides.length < 10) {
      //     current.textContent = `0${slideIndex}`;
      // } else {
      //     current.textContent = slideIndex;
      // }
...
function getResourses(_x3) {
  return _getResourses.apply(this, arguments);
}

function _getResourses() {
  _getResourses = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url) {
    var res;
